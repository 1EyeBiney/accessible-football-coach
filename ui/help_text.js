...
(function (root) {
    ...
    var GAME = [
        ...
        l('When a flag comes down in your favour, the ruling is yours: you hear the play, the flag, and both futures - what accepting does and what declining does - then Enter takes your coordinator\'s call and F offers the other. A flag with only one sensible answer, like pass interference on an incompletion, is ruled automatically the way it always was.'),
    ...
    var STEP_KEYS = {
        ...
        'penalty-call': {
            f: 'Options. Accept the penalty, or decline it and let the play stand. Both futures are spoken before you choose.'
        }
    };
